 ...
 * @author Adrián
 */
@WebServlet(name = "ServletListarCustomer", urlPatterns = {"/ServletListarCustomer"})
public class ServletListarCustomer extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String [] zipsCode = request.getParameterValues("zipCode");
        
        List<Customer> customers;
        if (buscador == null || buscador.isEmpty()){
            customers = this.customerFacade.findAll();
        } else {
            customers = this.customerFacade.findBySearchAndZipCode(buscador, zipsCode);
        }
        ...
        rd = this.getServletContext().getRequestDispatcher("/listadoCustomer.jsp");
